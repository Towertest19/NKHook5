...
void Signatures::FindAll() {
	...
	/* MonkeyLabScreen */
	pointerMap[Sigs::MonkeyLabScreen_CCTOR] = Signatures::FindFirst(1,
		// MonkeyLabScreen constructor - verified against BTD5-Win.exe.bak at VA=0x7B8160.
		// Anchored on the ScriptedScreen base-name construction for "MonkeyLabScreen".
	...
	/* SpecialtiesScreen */
	pointerMap[Sigs::SpecialtiesScreen_CCTOR] = Signatures::FindFirst(1,
		// SpecialtiesScreen constructor - verified against BTD5-Win.exe.bak at VA=0x7DFBD0.
		// Anchored on the ScriptedScreen base-name construction for "SpecialtiesScreen".
